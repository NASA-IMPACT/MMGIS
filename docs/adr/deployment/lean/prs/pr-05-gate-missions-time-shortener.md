...
- `MMGIS_DEPLOYMENT_MODE=lean`: `/api/utils/getprofile`, `/getbands`, `/getminmax`, `/queryTilesetTimes`, `/ll2aerll`, `/chronice`, and `/proj42wkt` return 404; `/api/utils/healthcheck` still responds.
