/**
 * Constants for LayerManager components
 */

// Layer types supported by MMGIS
...
// Layer types that support COG colormap controls
export const COG_SUPPORTED_TYPES = [LAYER_TYPES.TILE, LAYER_TYPES.IMAGE]

// Common matplotlib colormaps available in TiTiler
...
/**
 * Find the original colormap name (with correct casing) from the lowercase version
 * @param {string} lowercaseName - Colormap name (possibly lowercase)
 * @returns {string} Properly cased colormap name
 */
export const findColormapName = (lowercaseName) => {
