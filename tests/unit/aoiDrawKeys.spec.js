 ...
 * comes with it — starting one retracts the current selection's card — so
...
beforeEach(() => {
    ...
    window.mmgisAPI = {
        request: (name) => {
            ...
            // There is no camera behind these specs, and "no view" is an answer
            // the popup anchoring understands — `true` is not.
